...
class HomeHandler(BaseHandler):
	...
	if not tag:
        ...
        try:
            ...
            #news_feed = self.graph.get_search_all(tag)
            news_feed = self.graph.get_search_friends(tag)
...
def main():
    ...
    util.run_wsgi_app(webapp.WSGIApplication([
        (r"/searchfriends", HomeHandler),
        (r"/searchfriends", PostHandler),
    ], debug=debug))
